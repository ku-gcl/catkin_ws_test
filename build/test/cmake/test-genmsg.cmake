...
set(MSG_I_FLAGS "-Itest:/home/ubuntu/pendulum_project/catkin_ws_test/src/test/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ubuntu/pendulum_project/catkin_ws_test/src/test/msg/CustomState.msg" NAME_WE)
add_custom_target(_test_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "test" "/home/ubuntu/pendulum_project/catkin_ws_test/src/test/msg/CustomState.msg" ""
)
...
_generate_msg_cpp(test
  "/home/ubuntu/pendulum_project/catkin_ws_test/src/test/msg/CustomState.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/test)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/test\")")
  # install generated code
  install(
